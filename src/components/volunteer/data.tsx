const filters = ["All", "Development", "Design", "Marketing", "Other"];
...
• Dedicate at least 3 hours per week to the position (Note: time commitment fluctuates depending on frequency of projects and requests)`,
		type: "Development",
