...
export default function Succeed() {
	return (
		<StepLayout title="Succeed" number={3}>
			<div className="flex flex-col lg:flex-row float-left">
				<motion.img
				...
				>
					<h3 className="h3 uppercase tracking-[0.2em] mb-3 mt-1 text-left lg:text-right">
						<span className="text-glow">succeed</span> with our
						community
					</h3>
					<p className="py-5 mb-5 text-left lg:text-right">
					...
					<Link
						href="/discord"
						className="btn btn-primary w-full lg:btn-wide`"
					>
						Join Us!
					</Link>
				</motion.div>
