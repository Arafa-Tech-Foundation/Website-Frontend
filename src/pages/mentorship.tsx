	...
	return (
		<HomeLayout title="Mentorship Program">
			<Post matter={matter}>
				...
				<div className="mt-8 px-6 py-6 rounded-lg text-center bg-gray-800 md:py-12 md:px-12 lg:py-8 lg:px-16  xl:items-center">
					<div>
				...
				<ol>
					<li>
						...
						professionals with a wealth of knowledge and experience
						in various areas of technology. They are passionate
						about giving back to the community and are dedicated to
						helping students succeed.
					</li>
					<li>
						<b>Personalized Guidance:</b> Each student in our
						mentorship program is paired with a mentor who will
						provide personalized guidance tailored to their
						individual needs and goals. Whether you are a beginner
						or looking to advance your skills, our mentors will work
						closely with you to create a learning plan and provide
						ongoing support.
					</li>
					<li>
						<b>Project Feedback:</b> As part of the mentorship
						program, you will have the opportunity to showcase your
						coding projects and receive valuable feedback from your
						mentor. This feedback will help you improve your skills,
						gain insights into best practices, and refine your
						coding techniques.
					</li>
					<li>
						<b>Career Development:</b> Our mentors are not only
						focused on technical skills but also on helping you
						navigate the path to a successful career in the tech
						industry. They can provide advice on job search
						strategies, assist with resume and cover letter reviews,
						conduct mock interviews, and offer guidance on
				...
				<ol>
					<li>
						...
						program, you will need to complete an application form
						where you can provide information about your coding
						experience, goals, and areas of interest. We will
						carefully review your application and match you with a
						mentor who best aligns with your needs.
					</li>
					<li>
						<b>Initial Meeting:</b> Once you have been paired with a
						mentor, you will have an initial meeting to get to know
						each other better. During this meeting, you can discuss
						your goals, expectations, and establish a plan for your
						mentorship journey.
					</li>
					<li>
						<b>Ongoing Mentorship:</b> Your mentor will provide
						guidance, support, and resources to help you progress in
						your coding skills. You can schedule regular check-ins,
						ask questions, seek advice, and discuss your projects
						and challenges.
					</li>
					<li>
						<b>Project Feedback and Review:</b> As you work on
						coding projects, your mentor will provide feedback to
						help you improve and grow. They will offer constructive
						criticism, suggest alternative approaches, and share
						their expertise to enhance your coding abilities.
					</li>
					<li>
						<b>Career Support:</b> Your mentor will assist you in
						exploring potential career paths in the tech industry.
						They can help you identify job opportunities, review
						your application materials, and provide insights into
				...
				<ol>
					...
					program applicants:
					<li>
						<b>Dedication and Motivation:</b> We look for applicants
						who are motivated to learn and have a genuine interest
						in coding and technology. A strong dedication to
						self-improvement and a willingness to put in the effort
						to achieve your goals are key qualities we seek.
					</li>
					<li>
						<b>Openness to Feedback:</b> Being open to receiving
						feedback and a willingness to learn from mentors is
						crucial for growth. We value applicants who are
						receptive to constructive criticism and actively seek
						ways to improve their coding skills.
					</li>
					<li>
						<b>Commitment to Learning:</b> Learning to code requires
						consistent effort and practice. We seek applicants who
						are committed to investing time and effort in their
						coding education, attending mentorship sessions, and
						actively engaging in their learning journey.
					</li>
					<li>
						<b>Collaborative Mindset:</b> The tech industry thrives
						on collaboration and teamwork. We value applicants who
						possess a collaborative mindset and are willing to
						contribute to the success of the mentorship community by
						sharing their knowledge, experiences, and perspectives
						with others.
					</li>
					<li>
						<b>Curiosity and Problem-Solving Skills:</b> Coding
						involves solving problems and thinking creatively. We
						look for applicants who exhibit curiosity, critical
						thinking skills, and an eagerness to explore innovative
